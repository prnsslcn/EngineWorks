...
> = {
  ...
  marine: {
    label: "해양 엔진",
    description: "선박 추진 및 보조 동력을 위한 해양 환경 최적화 엔진입니다.",
  },
  other: {
    label: "기타 / 커스텀",
    description:
      ...
      <ScrollReveal from="up">
        <section className="space-y-6">
          <div className="space-y-3">
            ...
            <h1 className="ew-section-title">EngineWorks 엔진 라인업</h1>
            <p className="ew-section-subtitle max-w-2xl">
              산업, 발전, 해양 현장을 위해 설계된 EngineWorks의 엔진 제품들을 한
              곳에서 확인할 수 있습니다. 각 프로젝트의 부하 패턴과 설치 환경에
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <ScrollReveal from="up">
              <div className="ew-card-soft p-4 sm:p-5">
                ...
                <p className="mt-2 text-xs text-slate-500">
                  Supabase의 <code>engine_product</code> 테이블에 등록된 엔진
                  기준입니다.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal from="up" delay={120}>
              <div className="ew-card-soft p-4 sm:p-5">
                ...
                <p className="mt-2 text-xs text-slate-500">
                  프로젝트 요구에 따라 연료 타입과 배출 규제 수준을 함께
                  검토합니다.
                </p>
              </div>
            </ScrollReveal>
        ...
        <section className="space-y-4">
          <div className="ew-card-soft p-5 flex flex-col gap-3">
            ...
            <p className="text-xs sm:text-sm text-slate-600">
              Supabase 대시보드에서 <code>engine_product</code> 테이블에 엔진
              데이터를 추가하면, 이 페이지에서 자동으로 목록이 표시됩니다.
            </p>
          </div>
        </section>
      )}
