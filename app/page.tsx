    ...
    return (
        <div className="ew-section space-y-20">
                ...
                <section className="space-y-10">
                    ...
                    산업용 엔진
                                ...
                                <p className="text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl">
                                    ...
                                    고출력·고효율 엔진과 운영 솔루션을 제공합니다.
                                    설계부터 시운전, 예방 정비까지 전 과정을 함께하는
                                    엔지니어링 파트너입니다.
                                </p>
                            </div>
                      ...
                      Demo View
                                    ...
                                    <div className="grid gap-3 sm:grid-cols-2 text-xs sm:text-sm">
                                        <div className="space-y-2">
                                            <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2.5">
                                                <div>
                                                    <p className="text-[11px] text-slate-500">플랜트 #03</p>
                          ...
                          운전 중
                                            ...
                                            <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2.5">
                                                <div>
                                                    <p className="text-[11px] text-slate-500">조선소 #12</p>
                                                    <p className="text-sm font-medium text-slate-900">
                                                        시운전 베이
                                                    </p>
                                                </div>
                          ...
                          대기
                                        ...
                                        <div className="space-y-2">
                                            <div className="rounded-xl border border-slate-200 bg-white px-3 py-2.5">
                                                ...
                                                <p className="text-lg font-semibold text-slate-900">76%</p>
                                            ...
                                            <div className="rounded-xl border border-slate-200 bg-white px-3 py-2.5">
                                                ...
                                                <p className="text-lg font-semibold text-slate-900">12일</p>
                                    ...
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 space-y-1.5">
                                        <p className="text-[11px] text-slate-500">에이전트 코멘트</p>
                                        <p className="text-xs text-slate-700">
                                            플랜트 #03 엔진의 냉각수 온도가 기준치보다 3℃ 높습니다.
                                            부하 패턴과 냉각 라인 상태를 함께 점검하는 것을 추천합니다.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    {featuredEngines.length === 0 ? (
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                            {featuredEngines.map((engine) => (
                                <article
                                    key={engine.id}
                                    className="ew-card h-full flex flex-col p-4 sm:p-5 hover:shadow-[0_20px_60px_rgba(15,23,42,0.12)] transition-shadow"
                                >
            ...
            <ScrollReveal from="up" delay={100}>
                <section className="space-y-6">
                    <div className="space-y-1">
                        <h2 className="ew-section-title">엔진 그 이상을 제공하는 기술·서비스</h2>
